function shufflenet_2class_inference(inputFolder, outputFolder, trainedNetworkFile, labelFile)
% SHUFFLENET_2CLASS_INFERENCE
%
% Perform inference on Hartmann-Shack (HS) images using a pre-trained
% ShuffleNet-based binary classification model.
%
...
%
% Usage:
%   shufflenet_2class_inference(inputFolder, outputFolder, trainedNetworkFile)
%   shufflenet_2class_inference(inputFolder, outputFolder, trainedNetworkFile, labelFile)
%
% Inputs:
...
%   - Ground-truth labels can be numeric (0/1) or text ("valid"/"invalid")
    ...
    for i = 1:numImages
        ...
        % Resize image to match the input size required by ShuffleNet (typically 224x224)
...
%
% This function:
%   1. Convert grayscale to 3-channel RGB (required by ShuffleNet)
...
%
% Output:
%   imageOut - Preprocessed image ready for deep learning inference
