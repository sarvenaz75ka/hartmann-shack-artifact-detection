...
% inputSize = net_mobileNet.Layers(1).InputSize;
% 
...
%     net = trainnet(augimdsTrain, net_mobileNet, "crossentropy", options);
% 
...
testFolder = 'C:\Doctoral documents sarvi\Project\Artifact detection\16\4 classification\Dataset-Kfold-5';
