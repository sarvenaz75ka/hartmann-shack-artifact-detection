function run_artifact_classification(inputFolder, outputFolder, labelFile)
...
%
% Usage:
%   run_artifact_classification(inputFolder, outputFolder)
%   run_artifact_classification(inputFolder, outputFolder, labelFile)
%
% Inputs:
