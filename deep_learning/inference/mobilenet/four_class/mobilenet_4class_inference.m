function mobilenet_4class_inference(inputFolder, outputFolder, trainedNetworkFile, labelFile)
% MOBILENET_4CLASS_INFERENCE
%
% Perform inference on Hartmann-Shack (HS) images using a pre-trained
% MobileNet-based four-class classification model.
%
...
%
% Usage:
%   mobilenet_4class_inference(inputFolder, outputFolder, trainedNetworkFile)
%   mobilenet_4class_inference(inputFolder, outputFolder, trainedNetworkFile, labelFile)
%
% Inputs:
...
%     in the manuscript. Both terms refer to the same artifact type.
    ...
    for i = 1:numImages
        ...
        % Resize image to match the network input size
...
%
% This function:
%   1. Converts grayscale images to 3-channel RGB
%   2. Removes extra channels if present
