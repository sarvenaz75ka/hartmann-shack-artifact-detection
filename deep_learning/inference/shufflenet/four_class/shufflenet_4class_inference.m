function shufflenet_4class_inference(inputFolder, outputFolder, trainedNetworkFile, labelFile)
% SHUFFLENET_4CLASS_INFERENCE
%
% Perform inference on Hartmann-Shack (HS) images using a pre-trained
% ShuffleNet-based four-class classification model.
%
...
%
% Usage:
%   shufflenet_4class_inference(inputFolder, outputFolder, trainedNetworkFile)
%   shufflenet_4class_inference(inputFolder, outputFolder, trainedNetworkFile, labelFile)
%
% Inputs:
...
%   
    ...
    for i = 1:numImages
        ...
        % Resize image to match the input size required by ShuffleNet
        % (typically 224x224x3)
