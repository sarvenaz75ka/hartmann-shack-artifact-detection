...
inputSize = net_mobilenet_2class.Layers(1).InputSize;
...
for i = 1:numFolds
    ...
    options = trainingOptions("adam", ... % Use the Adam optimizer
        MaxEpochs=12, ... % Maximum number of epochs
    ...
    net = trainnet(augimdsTrain, net_mobilenet_2class, "crossentropy", options);
